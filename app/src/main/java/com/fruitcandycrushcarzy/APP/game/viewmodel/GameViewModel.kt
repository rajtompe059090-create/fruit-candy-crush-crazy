...
class GameViewModel(
            ...
            val nextTarget =
                when (nextLevel) {
                    ...
                    3 -> 1100
                        ...
                        _uiState.value.targetScore + 350
                }
     ...
     * REWARDED AD
     *
     * Ad system itself is NOT changed here.
     * MainActivity / AdManager handles the ad.
     * =====================================================
     */
